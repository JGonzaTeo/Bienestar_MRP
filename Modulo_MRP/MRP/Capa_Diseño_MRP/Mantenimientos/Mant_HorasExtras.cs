...
namespace Capa_Diseño_MRP.Mantenimientos
{
    public partial class Mant_HorasExtras : Form
    {
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { txt_codigo, txt_empleado, Txt_fechaHE, txt_cantidad };
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "horasextras", txt_codigo.Text, txt_empleado.Text, Txt_fechaHE.Text, txt_cantidad.Text, cbo_estado.Text };
                string[] campos = { "pkcodigohorasextras", "fkcodigoempleado", "fecha_hr", "cantidad", "estado" };
